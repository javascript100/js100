      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" v-bind:key="item.addressId" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;selectedAddId=item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
